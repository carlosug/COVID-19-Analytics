---
title: "Data Science FAIR - COVID-19"
...
kable(datatable,booktabs =T, longtable=T, caption = 'Appendix A. COVID-19 Cases Worldwide', format.args=list(big.mark=',')) %>% kable_styling(font_size=5, latex_options=c('striped', 'hold_position', 'repeat_header'))
